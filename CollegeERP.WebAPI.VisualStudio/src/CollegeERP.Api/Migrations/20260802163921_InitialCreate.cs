        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultSemester = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AttendanceThreshold = table.Column<int>(type: "int", nullable: false),
                    FeeReminderDays = table.Column<int>(type: "int", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MarkedByFacultyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    MarkedByName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendance_Faculty_MarkedByFacultyId",
                        column: x => x.MarkedByFacultyId,
                        principalTable: "Faculty",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternalMarks = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    ExternalMarks = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HodAuthorizations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HodAuthorizations_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HodAuthorizations_Users_DecidedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendance_MarkedByFacultyId",
                table: "Attendance",
                column: "MarkedByFacultyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HodAuthorizations_DecidedByUserId",
                table: "HodAuthorizations",
                column: "DecidedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_HodAuthorizations_DepartmentId",
                table: "HodAuthorizations",
                column: "DepartmentId");
